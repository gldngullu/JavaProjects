...
public class TreeDepthFirst {
    ...
    public static void main(String args[]) {
        ...
        TreeDepthFirst newGame = new TreeDepthFirst();
    ...
    private void printSolution(double[] bestSolutionInfo, TreeDepthFirst newGame){
    ...
    private double[] createTreeFindSolution() {
        ListNode theParent = (ListNode)stack.peek();
        while (!stack.isEmpty()) {
            ListNode current = (ListNode) stack.pop();
            int levelOfNode = -1;
            ...
            if(levelOfNode != elements.length+1 || tempRightValueWeight[2] >= bestSolution[2]) {//and olabilirmi
